...
frame.getContentPane().setBackground(new Color(20,50,30));
...
btPanel.setBackground(new Color(100,100,100));
	...
	for(int i=0;i<9;i++) {
		if(e.getSource()==button[i]) {
			if(pl1_chance) {
				...
				if(button[i].getText()=="") {
					button[i].setForeground(new Color(255,255,0));
					button[i].setText("O");
					pl1_chance=true;
					textfield.setText("X TURN");
					chance_flag++;
